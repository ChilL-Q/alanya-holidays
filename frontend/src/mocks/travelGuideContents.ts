    ...
    sections: [
      {
        ...
        body: "Alanya sits roughly 130 km east of Antalya Airport (AYT), which is your main international gateway. From the airport, you have three solid options: a private transfer (about 90 minutes, €50-70), the Havas shuttle bus (runs every 2 hours, €12 per person, drops you at the main bus terminal), or renting a car if you plan to explore beyond the city. If you are already in Turkey, intercity buses connect Alanya to all major cities — the otogar is about 3 km west of the center, and a quick dolmuş ride gets you into town for pocket change.",
      },
      {
        heading: "Where to Stay",
        body: "Alanya stretches along a 30 km coastline, and choosing the right neighborhood makes all the difference. Cleopatra Beach is the prime tourist zone — beachfront hotels, lively promenades, walking distance to everything. If you want something more residential and local, look at Oba — it has wider streets, better-value apartments, and a chilled-out cafe culture. The harbor area around the Red Tower is atmospheric for a short stay but can get noisy. For long-term stays, Mahmutlar and Kestel offer the best apartment deals and a more settled expat scene. Budget €30-80/night for a solid hotel, or €300-500/month for a long-term rental apartment depending on the season.",
      },
      {
      ...
      },
      {
        ...
        body: "Start at the harbor around 9 AM and climb up to Alanya Castle — the views alone are worth the 250-step ascent, and the entrance fee is modest. Walk the battlements, peek into Süleymaniye Mosque, then descend through the old neighborhood of Tophane with its Ottoman-era houses. Grab lunch at a harbor-side fish restaurant (the grilled sea bass is reliably excellent), then spend the afternoon floating at Cleopatra Beach — the sand is genuinely fine and the water is absurdly turquoise. End the day with sunset drinks at the Red Tower square, watching the boats bob in the harbor as the call to prayer echoes across the bay.",
      },
      {
  ...
  "Best Day Trips from Alanya": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "On a scorching July afternoon when Alanya is baking at 38°C, the Dimçay Valley is 10 degrees cooler and feels like a different planet. The river cascades down from the Taurus Mountains through a tree-shaded gorge lined with floating restaurants — wooden platforms built directly over the rushing water, with low tables where you sit cross-legged on cushions with your feet dangling in the icy stream. Order grilled trout (caught from the river that morning) and a cold ayran. Higher up, Dim Cave (Dim Mağarası) is the second-longest cave in Turkey, with a 360-meter walkable path through stalactite galleries. Combined, this is a perfect half-day escape from the coastal heat.",
      },
      {
      ...
      },
      {
        ...
        body: "About 40 km east of Alanya, Sapadere Canyon is a 750-meter wooden walkway suspended above a rushing turquoise river, pinned to sheer rock walls that narrow to just a few meters apart. At the end, a waterfall crashes into a natural pool where you can swim — the water is freezing even in August, and it is glorious. The canyon is managed (small entrance fee, well-maintained paths) so it feels accessible rather than dangerous. There is a cafe at the entrance run by the village cooperative — the gözleme here, made by village women on a wood-fired sac, is the best within 50 km. Plan 2-3 hours total including the drive from Alanya.",
      },
    ],
    relatedLinks: [
    ...
    sections: [
      {
        ...
        body: "Legend has it Cleopatra herself swam here, and honestly, she had taste. This 2 km stretch of impossibly fine golden sand is the crown jewel — shallow turquoise water that stays warm through October, a palm-lined promenade with cafes and bars, and the iconic Alanya Castle towering on the rocky headland to the east. The western end (near Damlataş Cave) is busier and better for families; the eastern end is slightly quieter. Sun loungers and umbrellas rent for about 100 TL per day. The beach shelves gently, so it is safe for kids and non-swimmers. Facilities are solid: showers, changing cabins, and beachfront restaurants that deliver food and drinks straight to your lounger. Go before 10 AM in peak summer to claim a good spot.",
      },
      {
