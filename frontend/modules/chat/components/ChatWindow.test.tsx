...
// Mock useChatStore - use real Zustand for proper state management
...
describe('ChatWindow', () => {
    ...
    beforeEach(() => {
        vi.clearAllMocks();
        vi.mocked(useChat).mockReturnValue(defaultChatContext);
    ...
    it('returns null if no active conversation', () => {
        vi.mocked(useChat).mockReturnValue({ ...defaultChatContext, activeConversationId: null });
