    ...
    return (
        <div className="bg-white dark:bg-slate-800/80 p-6 rounded-2xl border border-slate-100 dark:border-slate-800/50 h-fit">
            ...
            <div className="space-y-3">
                <NavLink to="/admin/fleet" className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-700/80 transition-colors group">
                    ...
                    <span className="font-medium text-slate-700 dark:text-slate-200">Manage Fleet</span>
                </NavLink>
                <NavLink to="/admin/properties" className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-700/80 transition-colors group">
                    ...
                    <span className="font-medium text-slate-700 dark:text-slate-200">Manage Properties</span>
                </NavLink>
