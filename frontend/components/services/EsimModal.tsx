        ...
        >
            <div className="space-y-6">
                <div className="text-center">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-teal-50 dark:bg-slate-800/50 text-teal-600 dark:text-cyan-400 dark:text-slate-200 mb-4">
                        <Smartphone size={32} />
                    </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-800/80 rounded-2xl p-6 border border-slate-100 dark:border-slate-800/50">
                    <div className="flex justify-between items-center mb-4 pb-4 border-b border-slate-200 dark:border-slate-800/50">
                        <div>
                        ...
                        <div className="text-right">
                            ...
                            <p className="text-xl font-bold text-teal-600 dark:text-cyan-400 dark:text-slate-200">{plan.price}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-white dark:bg-slate-800/80 rounded-lg shadow-sm">
                                <Zap size={18} className="text-teal-500 dark:text-cyan-400 " />
                            </div>
                            <div>
                        ...
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-white dark:bg-slate-800/80 rounded-lg shadow-sm">
                                <Check size={18} className="text-teal-500 dark:text-cyan-400 " />
                            </div>
                            <div>
                ...
                <div className="p-4 bg-blue-50 dark:bg-slate-800/50 rounded-xl border border-blue-100 dark:border-slate-700/50 flex gap-3">
                    <Info className="text-blue-600 dark:text-slate-200 shrink-0" size={20} />
                ...
                <div className="space-y-3">
                    <button
                        onClick={onConfirm}
                        className="flex items-center justify-center gap-2 w-full py-4 bg-slate-900 dark:bg-white text-white dark:text-white rounded-xl font-bold hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors shadow-lg shadow-slate-200 dark:shadow-none"
                    >
