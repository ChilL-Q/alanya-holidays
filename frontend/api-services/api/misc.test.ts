...
describe('favoritesService.addFavorite', () => {
     it('upserts favorite', async () => {
       ...
       await favoritesService.addFavorite({ item_id: 'i1' });
     ...
     it('throws on DB error', async () => {
       ...
       await expect(favoritesService.addFavorite({ item_id: 'i1' })).rejects.toBeTruthy();
     });
     ...
     it('throws when not authenticated', async () => {
       ...
       await expect(favoritesService.addFavorite({ item_id: 'i1' })).rejects.toThrow('Not authenticated');
     });
   });
...
describe('favoritesService.removeFavorite', () => {
     it('deletes favorite by user_id and item_id', async () => {
       ...
       await favoritesService.removeFavorite({ item_id: 'i1' });
     ...
     it('throws on DB error', async () => {
       ...
       await expect(favoritesService.removeFavorite({ item_id: 'i1' })).rejects.toBeTruthy();
     });
     ...
     it('throws when not authenticated', async () => {
       ...
       await expect(favoritesService.removeFavorite({ item_id: 'i1' })).rejects.toThrow('Not authenticated');
     });
   });
