        ...
        <div className="pt-24 pb-16 min-h-screen bg-slate-50 dark:bg-slate-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <span className="text-teal-600 dark:text-cyan-400 dark:text-slate-200 font-semibold tracking-wider text-sm uppercase mb-2 block">{t('visa.hero.badge')}</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    {/* Tourist Visa */}
                    <div className="bg-white dark:bg-slate-800/80 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800/50 relative overflow-hidden group animate-stagger-enter" style={{ animationDelay: '0ms' }}>
                        <div className="flex items-center gap-4 mb-6">
                            <div className="bg-teal-100 dark:bg-slate-800/50 p-3 rounded-xl text-teal-600 dark:text-cyan-400 dark:text-slate-200">
                                <Globe size={28} />
                            </div>
                        ...
                        <ul className="space-y-4 mb-8">
                            {[t('visa.tourist.list1'), t('visa.tourist.list2'), t('visa.tourist.list3')].map((item, i) => (
                                <li key={i} className="flex items-center gap-3 text-slate-700 dark:text-slate-300">
                                    <CheckCircle size={18} className="text-teal-500 dark:text-cyan-400 shrink-0" />
                                    {item}
                                </li>
                            ))}
                        </ul>
                        <div className="flex items-center justify-between pt-6 border-t border-slate-100 dark:border-slate-800/50">
                            <div>
                                ...
                                <div className="text-2xl font-bold text-teal-600 dark:text-cyan-400 ">€50</div>
                            </div>
                            <button
                                onClick={() => navigate('/visa-consult')}
                                className="bg-slate-900 dark:bg-white text-white dark:text-white px-6 py-2 rounded-lg font-semibold hover:opacity-90 transition-opacity">
                                {t('visa.btn_consult')}
                            </button>
                        </div>
                    </div >
                    ...
                    {/* Residence Permit */}
                    <div className="bg-white dark:bg-slate-800/80 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800/50 relative overflow-hidden group animate-stagger-enter" style={{ animationDelay: '150ms' }}>
                        <div className="flex items-center gap-4 mb-6">
                            <div className="bg-purple-100 dark:bg-slate-800/50 p-3 rounded-xl text-purple-600 dark:text-slate-200">
                                <FileCheck size={28} />
                            </div>
