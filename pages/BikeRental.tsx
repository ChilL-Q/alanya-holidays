...
export const BikeRental: React.FC = () => {
    ...
    const allBikeImages = BIKES.map(b => ({ src: b.image, title: b.title }));
    ...
    return (
        <div className="pt-24 pb-16 min-h-screen bg-slate-50 dark:bg-slate-900">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h1 className="text-4xl md:text-5xl font-serif text-slate-900 dark:text-white mb-6 leading-tight">
                            Zip Around Alanya on <span className="text-teal-600">Two Wheels</span>
                        </h1>
                        <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
                            Beat the traffic and explore hidden gems. Affordable scooters and powerful motorbikes for every rider.
                        </p>

                        <div className="flex flex-wrap gap-4 mb-10">
                            {['Free Helmet', 'Unlimited Mileage', ' roadside assistance'].map((feature, idx) => (
                        ...
                        <div className="flex gap-4">
                            <button className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-teal-600/20 transition-all duration-300 hover:shadow-teal-600/40 hover:scale-105 active:scale-95 flex items-center gap-2">
                                View Bikes <ChevronRight size={18} />
                            </button>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-3xl font-serif text-slate-900 dark:text-white mb-8">Popular Bikes</h2>
                            ...
                            <div className="p-5">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-xl font-bold text-teal-600">${bike.price}</div>
