            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-24">
                    <div className="md:w-1/2">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400 text-sm font-bold mb-6">
                            <Wifi size={16} />
                        ...
                        <h1 className="text-4xl lg:text-5xl font-serif text-slate-900 dark:text-white mb-6 leading-tight">
                            Stay Connected with <span className="text-teal-600 dark:text-teal-400">eSIM</span>
                        </h1>
                            ...
                            {[
                                ...
                                <div key={idx} className="flex items-center gap-3">
                                    <div className="p-2 bg-white dark:bg-slate-800 rounded-lg shadow-sm">
                                        <feature.icon size={20} className="text-teal-500" />
                                    </div>
                                ...
                                <div className="p-6 relative z-10 text-white h-full flex flex-col justify-end pb-12">
                                    <div className="bg-white/10 backdrop-blur-md p-5 rounded-2xl border border-white/20 mb-4">
                                        ...
                                        <div className="w-full bg-white/20 h-2 rounded-full overflow-hidden">
                                            <div className="bg-teal-400 h-full w-[70%]"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="mb-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                        ...
                        <div className="hidden md:block absolute top-1/2 left-1/4 right-1/4 h-0.5 bg-slate-200 dark:bg-slate-700 -translate-y-1/2 z-0"></div>
                        ...
                        {[
                            ...
                            <div key={idx} className="relative z-10 bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 text-center group hover:shadow-md transition-shadow">
                                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-teal-50 dark:bg-teal-900/20 text-teal-600 dark:text-teal-400 mb-6 group-hover:scale-110 transition-transform">
                                    <item.icon size={32} />
                                </div>
                                <span className="block text-4xl font-bold text-slate-100 dark:text-slate-700 absolute top-4 right-8">{item.step}</span>
                ...
                <div className="mb-24 bg-teal-50 dark:bg-teal-900/10 rounded-3xl p-10 border border-teal-100 dark:border-teal-800/50 flex flex-col md:flex-row items-center gap-10">
                    <div className="md:w-2/3">
                        ...
                        <div className="flex flex-wrap gap-3">
                            {['iPhone XS+', 'Samsung S20+', 'Google Pixel 3+', 'iPad Pro+', 'Apple Watch+'].map((tag) => (
                                <span key={tag} className="px-4 py-2 bg-white dark:bg-slate-800 rounded-full text-sm font-medium text-slate-700 dark:text-slate-300 shadow-sm">
                                    {tag}
                                </span>
                            ))}
                        </div>
                    ...
                    <div className="md:w-1/3 flex justify-center">
                        <div className="text-center">
                            <div className="mb-4 text-teal-600 dark:text-teal-400 font-bold text-lg">Dial *#06#</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    <a
                        ...
                        className="group relative overflow-hidden bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-lg border border-slate-100 dark:border-slate-700 hover:shadow-xl transition-all duration-300"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <span className="inline-flex items-center gap-2 text-teal-600 dark:text-teal-400 font-bold group-hover:gap-3 transition-all">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group relative overflow-hidden bg-teal-600 rounded-3xl p-8 shadow-lg shadow-teal-500/20 hover:shadow-xl hover:shadow-teal-500/30 transition-all duration-300"
                    >
                ...
                <div className="mb-16">
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {plans.map((plan) => (
                                <div key={plan.id} className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-100 dark:border-slate-700 hover:border-teal-500 dark:hover:border-teal-500 transition-all duration-300 group relative overflow-hidden">
                                    <div className="absolute top-0 right-0 p-4 bg-teal-50 dark:bg-teal-900/20 rounded-bl-2xl">
                                        <span className="font-bold text-teal-600 dark:text-teal-400">{plan.days} Days</span>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl font-bold hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors flex items-center justify-center gap-2"
                                    >
                                        <Download size={20} />
                                        Get eSIM Now
                                    </button>
