    ...
    return (
        <div className="pt-24 pb-16 min-h-screen bg-slate-50 dark:bg-slate-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-16">
                    <div className="md:w-1/2">
                        <h1 className="text-4xl lg:text-5xl font-serif text-slate-900 dark:text-white mb-6 leading-tight">
                            Stay Connected <br /> <span className="text-teal-600">Instantly</span>
                        </h1>
                        <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 max-w-lg">
                            No roaming fees. No swapping plastic cards. Download your Turkish eSIM in minutes and get online the moment you land.
                        </p>
                        ...
                        <div className="relative w-64 h-[500px] bg-slate-900 rounded-[3rem] border-8 border-slate-800 shadow-2xl p-4 flex flex-col items-center">
                            ...
                            <div className="w-full h-full bg-slate-800 rounded-[2.2rem] overflow-hidden relative">
                                ...
                                <div className="p-6 relative z-10 text-white h-full flex flex-col justify-center">
                                    ...
                                    <h3 className="text-center text-xl font-bold mb-2">eSIM Active</h3>
                                    <p className="text-center text-sm text-slate-300 mb-8">Turkey Tourist Plan</p>

                                    <div className="space-y-4">
                                        <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl flex items-center justify-between">
                                            <span className="text-sm">Data Left</span>
                ...
                {/* Plans Grid */}
                <h2 className="text-3xl font-bold text-center text-slate-900 dark:text-white mb-12">Popular Data Plans</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    {[
                        { gb: '5 GB', days: '7 Days', price: '€15' },
                        { gb: '10 GB', days: '15 Days', price: '€25', popular: true },
                        { gb: '20 GB', days: '30 Days', price: '€40' },
                    ].map((plan, idx) => (
                        <div
                            key={idx}
                        ...
                        >
                            ...
                            <div className="text-center mb-6">
                                ...
                                <div className="text-slate-500">{plan.days} validity</div>
                            </div>
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300"><Check size={16} className="text-teal-500" /> High speed 5G/4G</li>
                                <li className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300"><Check size={16} className="text-teal-500" /> Hotspot included</li>
                                <li className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300"><Check size={16} className="text-teal-500" /> Instant activation</li>
                            </ul>
