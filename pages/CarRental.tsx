...
export const CarRental: React.FC = () => {
    ...
    const allCarImages = CARS.map(c => ({ src: c.image, title: c.title }));
    ...
    return (
        <div className="pt-24 pb-16 min-h-screen bg-slate-50 dark:bg-slate-900">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h1 className="text-4xl md:text-5xl font-serif text-slate-900 dark:text-white mb-6 leading-tight">
                            Explore Alanya on <span className="text-teal-600">Your Own Terms</span>
                        </h1>
                        <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
                            From compact city cars to rugged 4x4s for mountain adventures.
                            Transparent pricing, full insurance included, and no hidden fees.
                        </p>

                        <div className="flex flex-wrap gap-4 mb-10">
                            {['Free Delivery', 'No Deposit Options', '24/7 Support'].map((feature, idx) => (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-3xl font-serif text-slate-900 dark:text-white mb-8">Popular Vehicles</h2>
                            ...
                            <div className="p-5">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-xl font-bold text-teal-600">${car.price}</div>
