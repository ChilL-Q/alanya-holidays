...
export const InboxPage: React.FC = () => {
    ...
    return (
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div className="flex h-[calc(100vh-200px)] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800/50 rounded-3xl overflow-hidden shadow-xl">
                {/* Sidebar List */}
                <div className={`${activeConversationId ? 'hidden md:flex' : 'flex'} w-full md:w-80 flex-col border-r border-slate-200 dark:border-slate-800/50 bg-white dark:bg-slate-900`}>
                    <div className="p-4 border-b border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-900/50">
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-2.5 bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-800/50 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all shadow-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-2 space-y-1 custom-scrollbar">
                        {filteredConversations.length === 0 ? (
                            <div className="flex flex-col items-center justify-center h-48 text-slate-400 text-center animate-in fade-in zoom-in-95 duration-300">
                                <div className="w-12 h-12 bg-slate-50 dark:bg-slate-800/80 rounded-full flex items-center justify-center mb-3">
                                    ...
                                    return (
                                        ...
                                        >
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <div className="relative shrink-0">
                                                        {conv.property?.images?.[0] ? (
                                                            ...
                                                            <div className="w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-800/80 flex items-center justify-center ring-1 ring-slate-100 dark:ring-slate-800">
                                                    ...
                                                    <div className="min-w-0">
                                                        <h3 className={`font-bold text-sm leading-tight truncate ${isActive ? 'text-teal-900 dark:text-slate-200' : 'text-slate-900 dark:text-white'}`}>
                                            ...
                                            <div className="flex justify-between items-center pl-[52px] relative z-10">
                                                <p className={`text-xs truncate max-w-[180px] leading-relaxed ${isActive ? 'text-teal-700 dark:text-cyan-400 /80 dark:text-slate-200 font-medium' : 'text-slate-500 dark:text-slate-400'}`}>
                ...
                <div className={`${activeConversationId ? 'flex' : 'hidden md:flex'} flex-1 flex-col bg-slate-50/50 dark:bg-slate-900/80 relative`}>
                    ...
                    {activeConversationId ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-slate-400 dark:text-slate-400 animate-in fade-in duration-500">
                            <div className="w-20 h-20 bg-teal-50 dark:bg-slate-800/80 rounded-full flex items-center justify-center mb-4 shadow-sm">
                                <MessageSquare size={32} className="text-teal-500 dark:text-cyan-400 /50" />
                            </div>
