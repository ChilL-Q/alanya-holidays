        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className={`flex items-center gap-2 px-6 py-2 rounded-lg font-bold text-white transition-colors disabled:opacity-50 text-sm ${editId ? "bg-indigo-600 hover:bg-indigo-700" : "bg-teal-600 dark:bg-cyan-600 hover:bg-teal-700"}`}
            >
              <Save size={18} />{" "}
              {saving
                ? "Processing..."
          ...
          <div className="bg-indigo-50 dark:bg-slate-800/50 border border-indigo-200 dark:border-indigo-800 p-4 rounded-xl mb-6 flex items-center gap-3 text-indigo-800 dark:text-slate-200 animate-in fade-in">
            ...
            <div>
              ...
              <p className="text-sm opacity-80">
                You are viewing the service with proposed changes applied. Click
                "Approve & Apply" to make them live.
              </p>
            </div>
          </div>
        )}
