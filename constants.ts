...
export const MOCK_PROPERTIES: Property[] = [
  {
    ...
    images: ['/properties/kleopatra-penthouse-main.png', 'https://picsum.photos/800/600?random=11', 'https://picsum.photos/800/600?random=12'],
    guests: 6,
    bedrooms: 3,
    bathrooms: 2,
    hostName: 'Mehmet Y.',
  ...
  },
  {
    ...
    images: ['/properties/tepe-villa-main.png', 'https://picsum.photos/800/600?random=21', 'https://picsum.photos/800/600?random=22'],
    guests: 8,
    bedrooms: 4,
    bathrooms: 3,
    hostName: 'Elena K.',
  ...
  },
  {
    ...
    images: ['/properties/oba-apartment-main.png', 'https://picsum.photos/800/600?random=31'],
    guests: 4,
    bedrooms: 2,
    bathrooms: 1,
