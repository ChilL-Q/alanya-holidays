...
export const ValueProps: React.FC = () => {
    ...
    return (
        <section className="bg-white dark:bg-slate-900 py-8 md:py-12 border-b border-slate-100 dark:border-slate-800/50 transition-colors">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div className="p-4 animate-fade-up delay-100 opacity-0 fill-mode-forwards">
                    <div className="w-12 h-12 bg-primary/10 dark:bg-primary/20 text-primary dark:text-slate-200 rounded-full flex items-center justify-center mx-auto mb-4 transition-transform hover:scale-110 duration-300">
